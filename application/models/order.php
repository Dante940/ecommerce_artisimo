...
class Order extends CI_Model {
	...
	public function checkout($post){
		...
		$new_empty_cart = array();
		$this->session->set_userdata('cart',$new_empty_cart);
